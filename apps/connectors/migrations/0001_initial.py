    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('connector_type', models.CharField(choices=[('local_directory', 'Local directory'), ('sftp', 'SFTP (coming soon)'), ('postgres', 'PostgreSQL (coming soon)')], default='local_directory', max_length=40)),
